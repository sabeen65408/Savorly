    ...
    return (
      ...
      <div className="app">
        ...
        <main className="not-found">
          ...
          <p>
            Getting the recipe ready to edit.
          </p>
